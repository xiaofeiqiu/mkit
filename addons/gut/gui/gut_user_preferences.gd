...
func _init(editor_settings):
	...
	run_externally_options_dialog_size = GutEditorPref.new(
		"run_externally_options_dialog_size", Vector2i(-1, -1), editor_settings
	)
	shortcuts_dialog_size = GutEditorPref.new(
		"shortcuts_dialog_size", Vector2i(-1, -1), editor_settings
	)
