...
| ③ Boot | 挂好 `GameBootstrap` 并设 `resource_databases` | 注册所有服务，加载内容，校验 ID 唯一性 |
| ④ 构建实体 | 在场景树搭 EntityRoot / Components / Controllers | EntityRoot 提供 `get_component()` 快捷方法 |
...
- [架构层模型](../architecture.md) — 理解 Kernel / Module / Game 三层
