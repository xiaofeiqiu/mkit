...
- [Module Layer](module_layer.md)：可复用 gameplay domain 模块，例如 entity、combat、stats、ability、inventory、loot、room、run、progression、AI、interaction、UI feedback。
...
- [Pipeline](pipeline.md)：完整运行管线索引，覆盖启动、内容注册、命令、事件、HFSM、Action、Effect、战斗、背包、房间、奖励、存档、UI、平台服务和 Debug。
