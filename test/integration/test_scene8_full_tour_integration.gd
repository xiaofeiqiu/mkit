...
func test_tc_int_scene8_07_save_manager_round_trips_player_components_and_scopes() -> void:
	...
	assert_true(saved.has("scope_manifest"))
	var manifest: Dictionary = saved.get("scope_manifest", {})
	assert_true(manifest.has("world.zone"))
	assert_true(manifest.has("world.run"))
